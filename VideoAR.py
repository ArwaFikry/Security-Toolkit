...
def info():
    messagebox.showinfo('Text Steganography', 'Successful Process')
...
def display():
    ...
    lb3 = CTkLabel(root, text=": أدخل الرسالة السرية", font=('Helvetica', 22,'bold'), bg_color="#000e17", text_color="white")
    lb3.place(x=380, y=65)
    ...
    countdown_label = CTkLabel(root, text=f": الحروف المتبقية {max_chars}", font=('Helvetica', 12,'bold'),
                               bg_color="#01192a")
    countdown_label.place(x=455, y=301)
    ...
    but3 = CTkButton(root, text="تصفح", command=lambda: action("browse_file"), width=50, height=20,
    ...
    ho.CreateToolTip(but4, 'المرئي المقطع في الاخفاء تنفيذ')
