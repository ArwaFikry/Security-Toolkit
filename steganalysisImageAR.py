...
def display1():
    ...
    lb1 = CTkLabel(root, text="تحليل الصورة", font=('Helvetica', 25, 'bold'), bg_color='#000d16')
    lb1.place(x=400, y=120)
    ...
    ho.CreateToolTip(but4, 'الصورة من البيانات تحليل تنفيذ')
