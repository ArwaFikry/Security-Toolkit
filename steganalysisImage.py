...
def display1():
    ...
    global root
    root = CTk()
    root.title('Steganalysis of image')
    ...
    lb1 = CTkLabel(root, text="Steganalysis", font=('Helvetica', 25, 'bold'), bg_color='#000d16')
    lb1.place(x=360, y=120)

    lb3 = CTkLabel(root, text="Choose stego file :", font=('Helvetica', 25, 'bold'), bg_color='#000c18')
    lb3.place(x=150, y=230)
    ...
    lb4 = CTkLabel(root, text="Enter encryption key :", font=('Helvetica', 25, 'bold'), bg_color='#011627')
    lb4.place(x=150, y=300)

    global ent2
    ent2 = CTkEntry(root, width=180, height=25, fg_color="white")
    ent2.place(x=500, y=300)
