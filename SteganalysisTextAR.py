...
def display1():
    ...
    lb1 = CTkLabel(root, text="تحليل النص", font=('Helvetica', 25, 'bold'), bg_color='#000d16')
    lb1.place(x=410, y=120)
    ...
    ho.CreateToolTip(but4, 'النص من البيانات تحليل تنفيذ')
