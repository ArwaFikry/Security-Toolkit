...
def gohome():
    root.destroy()
    from DEcryptionPage import main5
    main5()
...
def display():
    ...
    global root
    root = CTk()
    root.title('Decryption Ceaser Cipher')
    ...
    but1 = CTkButton(root, text="Back", command=gohome, width=150, height=30,
                     font=('Helvetica', 15, 'bold'), corner_radius=25, bg_color='#001624', fg_color='#0d326e',image=image2)
    ...
    lb4 = CTkLabel(root, text="Enter decryption key :", font=('Helvetica', 25), bg_color='#001727')
    ...
    ho.CreateToolTip(but4, 'processed decryption data')
