...
def display1():
    ...
    lb1 = CTkLabel(root, text="تحليل مقطع صوتي", font=('Helvetica', 25, 'bold'), bg_color='#000d16')
    ...
    ho.CreateToolTip(but4, 'الصوتي المقطع من البيانات تحليل تنفيذ')
