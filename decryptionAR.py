...
def gohome():
    root.destroy()
    from DecryptionPageAR import main5
    main5()
...
def display(num):
    ...
    lb2 = CTkLabel(root, text=": ادخل النص", font=('Helvetica', 25), bg_color='#000e17')
    ...
    lb3 = CTkLabel(root, text=": اختر ملف", font=('Helvetica', 25), bg_color='#001423')
    lb3.place(x=480, y=400)

    but3 = CTkButton(root, text="تصفح", command=lambda: action("path"), width=180, height=25, image=image,
                     font=('Helvetica', 15, 'bold'), corner_radius=25, bg_color='#001729', fg_color='#0d326e')
    but3.place(x=270, y=400)

    lb4 = CTkLabel(root, text=": ادخل مفتاح التشفير", font=('Helvetica', 25), bg_color='#001727')
    lb4.place(x=480, y=342)

    global ent2
    ent2 = CTkEntry(root, width=180, height=25, fg_color='white')
    ent2.place(x=270, y=340)
    ...
    ho.CreateToolTip(but4, 'المعلومات تشفير فك تنفيذ')
